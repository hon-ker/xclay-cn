...
.v-md-editor .codemirror-wrapper,
.v-md-editor .codemirror-wrapper .CodeMirror {
  height: 100%
}

.v-md-editor .codemirror-wrapper.codemirror-reset .CodeMirror {
  color: #2c3e50;
  font-size: 14px;
...
.v-md-editor .codemirror-wrapper.codemirror-reset .CodeMirror:hover .CodeMirror-overlayscroll-horizontal>div,
.v-md-editor .codemirror-wrapper.codemirror-reset .CodeMirror:hover .CodeMirror-overlayscroll-vertical>div {
  opacity: 1
}

.v-md-editor .codemirror-wrapper.codemirror-reset .CodeMirror pre {
  padding: 0 12px;
  word-break: break-all
}

.v-md-editor .codemirror-wrapper.codemirror-reset .CodeMirror-empty {
  color: #c0c4cc
}

.v-md-editor .codemirror-wrapper.codemirror-reset .cm-header,
.v-md-editor .codemirror-wrapper.codemirror-reset .cm-link,
.v-md-editor .codemirror-wrapper.codemirror-reset .cm-url {
  color: #1890ff
}
...
.v-md-editor .codemirror-wrapper.codemirror-reset .cm-comment,
.v-md-editor .codemirror-wrapper.codemirror-reset .cm-link,
.v-md-editor .codemirror-wrapper.codemirror-reset .cm-quote,
.v-md-editor .codemirror-wrapper.codemirror-reset .cm-variable-2:not(.cm-url) {
  color: #2c3e50
}

.v-md-editor .codemirror-wrapper.codemirror-reset .CodeMirror-selected {
  background: #d1dae6
}

.v-md-editor .codemirror-wrapper.codemirror-reset .CodeMirror-linenumbers {
  padding: 0 5px
}

.v-md-editor .codemirror-wrapper.codemirror-reset .CodeMirror-overlayscroll-horizontal>div,
.v-md-editor .codemirror-wrapper.codemirror-reset .CodeMirror-overlayscroll-vertical>div {
  background-color: rgba(144, 147, 153, .3);
  border-radius: 4px;
  cursor: pointer;
  opacity: 0;
  -webkit-transition: opacity .34s ease-out, background-color .3s;
  transition: opacity .34s ease-out, background-color .3s
}

.v-md-editor .codemirror-wrapper.codemirror-reset .CodeMirror-overlayscroll-horizontal>div:hover,
.v-md-editor .codemirror-wrapper.codemirror-reset .CodeMirror-overlayscroll-vertical>div:hover {
  background-color: rgba(144, 147, 153, .5)
}

.v-md-editor .codemirror-wrapper.codemirror-reset .CodeMirror-overlayscroll-vertical {
  right: 2px
}</style>